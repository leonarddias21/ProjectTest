...
public class VirtualTrainingScheduleCancelTest extends AuthTest {

	@Test(priority = 1)
	public void virtualTrainingScheduleCancelTest() throws InterruptedException {
		...
		delay(5000);
		personalTrainingPage.scrollVTDown();
		delay(5000);
		personalTrainingPage.clickVirtualAppointmentLink();
		delay(3000);
