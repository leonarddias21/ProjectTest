...
public class ScheduleAppointmentRepeatTest extends AuthTest {

	@Test(priority = 1)
	public void scheduleAppointmentRepeatTest() throws InterruptedException {
		...
		personalTrainingPage.selectRepeatClient();
		delay(3000);
		...
		delay(3000);
		personalTrainingPage.clickRepeatCheckbox();
		personalTrainingPage.scrollTillSunday();
		personalTrainingPage.selectAllDays();
