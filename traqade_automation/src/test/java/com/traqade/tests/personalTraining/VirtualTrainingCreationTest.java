...
public class VirtualTrainingCreationTest extends AuthTest {

	@Test(priority = 1)
	public void virtualTrainingCreationTest() throws InterruptedException {
		...
		personalTrainingPage.selectVirtualTraining();
		personalTrainingPage.selectVirtualClient();
		delay(3000);
